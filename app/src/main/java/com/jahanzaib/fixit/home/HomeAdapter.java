...
public class HomeAdapter extends ArrayAdapter<HomeDetail> {

    Intent intent;
    Context context;

    public HomeAdapter(Context context, ArrayList<HomeDetail> arrayList) {
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        final String[] To = {"electric@gnaiul.comn"};
        final String[] CC = {""};
